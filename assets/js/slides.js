...
{ type:"content", kicker:"Company Profile", title:"About De-AirTech", chip:"Company Profile",
  layout:"r6040",
  main:[
    {lead:["Our Heritage",["Founded in Shanghai in 2019, De-AirTech was created by senior engineers and managers formerly with Hamon (Belgium) and AAF (USA) — two pioneers of industrial air-pollution control — carrying 20+ years of fabric-filter expertise into a focused, independent company."]]},
    ...
    {lead:["Global Application",["In-situ emission-control systems across diverse industries worldwide let us confidently apply our technology to any requirement."]]}
  ],
  side:[
...
{ type:"content", kicker:"Service & Support", title:"ESP to FF Conversion", chip:"Service & Support",
  layout:"rows",
  rows:[
    {split:true, ratio:"r5050", gap:"40px", cols:[
      [ {label:"Conversion in progress → completed"},
        {beforeAfter:{before:IMG+"conv_during.jpg", after:IMG+"conv_done.jpg",
          bl:"During conversion", al:"Completed filter"}} ],
      [ {label:"Old ESP → new fabric filter"},
        {beforeAfter:{before:IMG+"esp_old.jpg", after:IMG+"esp_new.jpg",
          bl:"Before — old ESP", al:"After — bag filter"}} ]
    ]},
    {split:true, ratio:"r6040", gap:"40px", cols:[
      [ {lead:["Convert, Don't Rebuild",[
          "An existing Electrostatic Precipitator (ESP) can be converted to a fabric filter — reusing the old casing, hoppers, supports and dust-conveying system, on supply (EP) or turnkey (EPC) basis."]]},
        {stats:[ {p:"<",n:"10",u:" mg/Nm³",l:"Emission after conversion"},{n:"15",u:"+",l:"Conversions delivered"} ], cls:"c2"} ],
      [ {label:"More project references — delivered by De-AirTech"},
        {figs:{srcs:[IMG+"image28.jpg",IMG+"image29.jpg"], cols:2, ar:"4/3",
          caps:["Cement-plant ESP conversion","New fabric filter installed"]}} ]
    ]}
  ]},
  ...
  rows:[
    ...
    {split:true, ratio:"r6040", gap:"34px", cols:[
      [ {label:"Case Reference · Lafarge (clinker cooler / kiln + raw mill)"},
        {stats:[ {n:"230→<10",u:" mg/Nm³",l:"Emission reduced"},{n:"30→8",u:" /yr",l:"Annual shutdowns"},
